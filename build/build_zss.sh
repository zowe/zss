...
# God only knows what modes of xlc/c89 want which link library specifications!
export _LD_SYSLIB="//'SYS1.CSSLIB'://'GDDM.SADMMOD'://'ISP.SISPLOAD'://'CEE.SCEELKEX'://'CEE.SCEELKED'://'CEE.SCEERUN'://'CEE.SCEERUN2'://'CSF.SCSFMOD0'://'CBC.SCCNOBJ'"
