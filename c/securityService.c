...
static void respondToProfileAccessListDELETE(ClassMgmtCommonParms *commonParms,
  ...
  if (strlen(commonParms->accessListEntryID) == 0) {
    ...
    zowelog(NULL, LOG_COMP_ID_SECURITY, ZOWE_LOG_WARNING,
           LOG_COMP_ACCESS_REQ_ACCESS_DEL);
    return;
  }
